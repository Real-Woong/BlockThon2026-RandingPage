 ...
 *
 * 줄바꿈
 *   본문 문단의 `\n` 은 데스크톱(1120px 이상)에서 그대로 줄바꿈이 됩니다.
 *   그보다 좁은 화면에서는 공백처럼 흘러가고 자동 줄바꿈을 따릅니다 —
 *   데스크톱 기준으로 잡은 줄이 모바일에서는 어색하게 끊기기 때문입니다.
 *   적용되는 곳: about.body / about.principles / stack.intro / stack.suiRole /
 *   stack.walrusRole / stack.output / resources.intro / program.intro /
 *   program.phases[].description / tracks[].summary / criteria[].description
 *
 * 화면에서 확인
...
export const event: EventContent = {
  ...
  about: {
    statement: '해커톤을 넘어\n생태계의 빌더로',
    body:
      'Blockthon 2026은 일회성 개발 행사에 머무르지 않습니다.\n' +
      'AI 개발자와 예비 창업가가 Sui와 Walrus를 배우고 활용하며,\n' +
      '행사 이후에도 프로젝트를 발전시키고 Sui 생태계에서\n' +
      '지속적으로 빌딩할 수 있도록 지원합니다.',
    principles: [
      'AI와 블록체인의 접점에서\n새로운 가능성을 발견한다',
      '기술 교육과 멘토링을 통해\n생태계의 빌더로 성장한다',
      '우수 팀의 후속 개발과\n글로벌 생태계 진출을 연결한다',
  ...
  stack: {
    intro:
      '익숙한 AI 기술에 Sui의 온체인 기능과 Walrus의 분산형 데이터 저장을 결합해보세요.\n' +
      '블록체인 경험이 많지 않아도 사전 세션과 기술 멘토링을 통해 필요한 스택을 배우며\n' +
      '개발할 수 있습니다.',
    suiRole:
      '빠른 트랜잭션과 디지털 자산의 소유권을 활용해\n' +
      'AI 서비스에 결제, 권한, 보상과\n' +
      '온체인 기능을 더할 수 있습니다.',
    walrusRole:
      'AI 모델, 미디어, 학습 데이터처럼\n' +
      '용량이 큰 데이터를 분산형 환경에 저장하고\n' +
      '서비스에서 활용할 수 있습니다.',
    modules: [
    ...
    output: 'AI와 블록체인의 결합을 자유롭게 실험하고,\n실제로 작동하는 프로젝트를 완성해보세요.',
  },
  ...
  resources: {
    intro:
      'Sui와 Walrus로 개발할 때 필요한 공식 문서와 도구입니다.\n' +
      '블록체인이 처음이라면 Walrus의 Getting started부터\n' +
      '순서대로 따라가면 됩니다.',
    groups: [
      {
        title: 'Walrus',
  ...
  program: {
    intro:
      '약 2주간의 온라인 예선을 시작으로\n기술 세션과 팀 빌딩, 오프라인 해커톤과 Demo Day까지 이어집니다.',
    phases: [
      {
        ...
        title: '온라인 예선 해커톤',
        description:
          '약 2주간 팀별 프로젝트를 개발합니다.\n' +
          '개인 또는 최대 4인으로 참가할 수 있으며,\n' +
          '제출 프로젝트를 바탕으로\n' +
          '오프라인 본선 진출팀을 선정합니다.',
      },
      {
  ...
  criteria: [
    {
      title: '기술 구현 및 완성도',
      description:
        '핵심 기능이 안정적으로 작동하고, 프로젝트의 아이디어와 기술 구조를\n데모를 통해 명확하게 보여주는지 평가합니다.',
      weight: '30%',
    },
    {
      title: 'Sui · Walrus 활용도',
      description:
        'Sui 또는 Walrus의 기술적 특성을 프로젝트에 적절히 활용하고,\n해당 기술을 선택한 이유가 명확한지 평가합니다.',
      weight: '25%',
    },
    {
      title: 'AI × Blockchain 결합',
      description:
        'AI와 블록체인의 장점을 자연스럽게 결합해\n기존 방식과 다른 경험이나 가치를 제시하는지 평가합니다.',
      weight: '25%',
    },
    {
      title: '문제 정의 및 발전 가능성',
      description:
        '해결하려는 문제와 대상 사용자가 명확하고,\n해커톤 이후에도 프로젝트를 발전시킬 가능성이 있는지 평가합니다.',
      weight: '20%',
    },
  ],
  ...
  partners: {
    ...
    // 단색 반전 사용으로, 형태는 원본 그대로입니다. 사용 허가를 받았습니다.
    mainPartners: [
